...
// CustomerModel is the GORM model for customers table (commerce profile).
// Registered buyers link to users via user_id; guest checkout stores contact snapshot here.
...
type CustomerAddressModel struct {
	...
	Type       string    `gorm:"type:address_type;not null"`
