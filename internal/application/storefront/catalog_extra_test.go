...
func TestSearchProducts(t *testing.T) {
	...
	svc := NewService(repo, catalogCategoryRepo{}, &catalogExtraBrandRepo{}, nil, nil, nil, nil, noopMailer{})
...
func TestListBrands(t *testing.T) {
	...
	svc := NewService(newCatalogExtraProductRepo(), catalogCategoryRepo{}, brands, nil, nil, nil, nil, noopMailer{})
...
func TestGetShippingMethods(t *testing.T) {
	svc := NewService(nil, nil, nil, nil, nil, nil, nil, noopMailer{})
